...
var argv = yargs
  ...
  .option('stroke', {describe: 'stroke color', default: 'black'})
  .option('fill', {describe: 'font fill color', default: 'black'})
  .option('mode', {describe: 'mode dark light', default: 'light'})
  .option('opacity', {describe: 'opacity', default: ''})
  .option('type_colors', {describe: 'type 0-7 colors', type: 'array', default: []})
